# ⚖️ Intelligent Agents for Tamil Law

> Graph RAG legal reviewer optimized for Tamil translation. Connects to Telegram channels for output sharing.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/tamil-law-agents/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-tamil-law-agents.git
cd tp-tamil-law-agents
```
...
```bash
kubectl port-forward deployment/tp-tamil-law-agents 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── tamil_law_agent.py     # Main configuration file
```
...
---
*Generated by [Intelligent Agents for Tamil Law Studio](https://pradeeptalari14.github.io/portfolio/tools/tamil-law-agents/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
